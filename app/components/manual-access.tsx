  ...
  return (
    <>
      ...
      <CommonModal open={open} setOpen={setOpen}>
        <h2 className='text-2xl font-semibold text-light mb-4'>Ingreso manual</h2>
        <label className='w-full flex flex-col gap-y-2 my-2'>
          <h5 className='font-semibold text-sm text-light'>
            Alias
          </h5>
          <input className='w-full text-light h-12 px-2 text-sm bg-background rounded-lg' />
        </label>
